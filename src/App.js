...
<main className="min-h-screen">
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-y-3 gap-x-4">
    ...
    Tap the number button below and <b>mention health,allowance</b> to get your <b>$5800</b>, It only takes 2 minutes.
                ...
                <p id="msg16disapproved" className="text-md text-gray-800 hidden">Tap the blue button below to fill out your submission. It only takes 2 minutes!</p>
              </div>
...
<footer className="bg-gray-100 border-t border-t-1 border-t-gray-200 mt-8">
  <div className="mx-auto max-w-7xl overflow-hidden px-6 py-8 lg:px-8 text-sm sm:text-md leading-5 sm:leading-6 text-gray-500">
    <p className="text-center pb-8">americanfinancehelp.com is a referral service that offers information and connects consumers with a helpline to potentially find companies offering specific insurance coverage. americahealthbenefits.com does not function as an insurance broker or make decisions regarding available insurance coverage. It does not guarantee specific outcomes or results from contacting the helpline. While the helpline itself is free to call, the services or programs you choose to pursue may come with associated costs. americahealthbenefits.com and any supplemental insurance plans you may be connected with are not endorsed by the U.S. Government or the federal Medicare program.</p>
    <p className="text-center pb-8">Our goal is to provide exceptional service. One of our agents may reach out to you to discuss your order, ask for feedback, and/or see if you need any assistance with your products, services, or plans, at the phone number you provided regardless of your do-not-call list status. You may opt-out of further contact at any time by simply telling our customer service team that you would no longer like to be contacted. In the event that our team is unable to reach you by phone, they may send you a text message letting you know that we called. Both our text messages and phone calls may be sent or connected utilizing automated software. Carrier charges may apply. You may opt-out of any future contact via text message by replying anytime with "STOP".</p>

  
    <p className="text-center pb-4 text-blue-400"><span><a href="/footer/privacy-policy" target="_blank">Privacy Policy</a> | <a href="/footer/terms-and-conditions" target="_blank">Terms &amp; Conditions</a></span></p>
